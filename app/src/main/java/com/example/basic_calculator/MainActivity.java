...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        ...
        if(buttonText.equals("C")){
            if(ChooseSign) ChooseSign = false;
            ...
            if(buttonText.equals("*") || buttonText.equals("/") || buttonText.equals("-") || buttonText.equals("+")){
                ...
                if(!ChooseSign && !solutionTv.getText().equals("")) dataToCalculate += buttonText;
                ChooseSign = true;
            }
            else{
                ChooseSign = false;
                //if "=" is pressed when choosing number erase the result
                if(calculated){
    ...
    String getResult(String data){
        try{
            ...
            if(finalResult.equals("org.mozilla.javascript.Undefined@0")) finalResult = "0";
            return finalResult;
        }catch (Exception e){
            return "Error";
        }
